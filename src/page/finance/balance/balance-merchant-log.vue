<template>
  <div>
    ...
    <div class="d-flex mt-20">
      <pg-search placeholder="商户名称" v-model="query.merchant_title" @change="changeQuery" />
      <pg-search class="ml-20" placeholder="操作人名称" v-model="query.operator_name" @change="changeQuery" />
    ...
    >
      ...
      <pg-column prop="merchant_title" title="商户" width="120"></pg-column>
