  ...
  yy: [
    {
      ...
      items: [
        ...
        { title: '区域', permission_code: 'Province', url: '/system/province' },
        { title: '片区', permission_code: 'Zone', url: '/system/zone' },
        { title: '县域', permission_code: 'City', url: '/system/city' },
        { title: '仓', permission_code: 'Storehouse', url: '/system/storehouse' },
      ],
    },
  ],
  gyl: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: '库存出入汇总', client: 'gyl', permission_code: 'WarehouseSupPlaceStockChangeQuery', url: '/warehouse/inventory-summary' },
        { title: '周转箱', client: 'gyl', permission_code: 'WarehouseSupTurnBoxQuery', url: '/warehouse/turnover-box' },
    ...
    },
    {
      ...
      items: [
        ...
        { title: '发车', client: 'gyl', permission_code: 'OperateDepartMain', url: '/operate/depart' },
        { title: '调拨装车', client: 'gyl', permission_code: 'OperateDisTruckLoadMain', url: '/operate/dis/truck/load' },
        { title: '线路规划', client: 'gyl', permission_code: 'OperateLineMain', url: '/operate/line' },
        { title: '配送人员', client: 'gyl', permission_code: 'Deliver', url: '/operate/deliver' },
        { title: '退筐', client: 'gyl', permission_code: 'OperateRefundFrame', url: '/operate/refund/frame' },
      ],
    },
  ],
  bsc: [
    ...
    // },
    {
      ...
      permission_code: 'Bsc',
      items: [
        { title: '会员等级', client: 'sc', permission_code: 'BscMerchantVip', url: '/merchant/vip' },
        { title: '黑名单', client: 'sc', permission_code: 'BscMerchantBlacklist', url: '/merchant/blacklist' },
        { title: '品牌信息设置', client: 'sc', permission_code: 'BscSettingBrand', url: '/setting/brand' },
        { title: '区域运营设置', client: 'sc', permission_code: 'BscSettingOperation', url: '/setting/operation' },
      ],
    },
  ],
  cls: [
    {
      ...
      items: [
        ...
        { title: '商品库存', permission_code: 'ClsItemStock', url: '/item/stock' },
